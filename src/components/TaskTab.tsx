    ...
    <div className="w-full flex dark:bg-dark_white bg-white h-16 rounded-3xl items-center p-8 justify-between">
      <div className="flex space-x-8 text-sm">
        ...
        >
            ...
            <p className={`dark:font-bold ${activeTab == "all" && "font-bold"}`}>All Tasks</p>
            <div
        ...
        >
          <p className={`dark:font-bold ${activeTab == "todo" && "font-bold"}`}>To do</p>
        ...
        >
          <p className={`dark:font-bold ${activeTab == "inprogress" && "font-bold"}`} >In progress</p>
          <div  className={`w-7 h-5 flex items-center justify-center rounded-md ${
        ...
        >
          <p className={`dark:font-bold ${activeTab == "completed" && "font-bold"}`}>Completed</p>
          <div  className={`w-7 h-5 flex items-center justify-center rounded-md ${
      ...
      <div className="flex text-gray space-x-4 text-sm cursor-pointer">
        <div className="flex space-x-2 border border-light_gray rounded-lg px-6 py-2 ">
          ...
          <p className='dark:font-bold'>Filter & Sort</p>
        </div>
